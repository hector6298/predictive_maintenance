...
if __name__ == "__main__":
    ...
    # Variables
    acr_login_server = args.arc_server
    ...
    create_options_telemetry_str = json.dumps(create_options_telemetry)     
    create_options_inference_str = json.dumps(create_options_inference)  
